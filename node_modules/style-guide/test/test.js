...
(0, _tape2['default'])('build a template', function (t) {
  ...
  Promise.all(sections).then(function (sections) {
    ...
    var compiled = guide.compile('test/templates/guide.hbs');
